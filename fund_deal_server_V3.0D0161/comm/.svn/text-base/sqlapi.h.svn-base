...
{
public:
    CMySQL(const char* host , const char* user , const char* pswd , const int port = 3306, int iOverTime = 5, const char*  charset = "latin1", const char * db_name = "", int iIdleTime=600);
	CMySQL(const std::string& host, const std::string& user, const std::string& pswd, const int port = 3306, int iOverTime = 5, const std::string& charset = "latin1", const std::string& db_name = "", int iIdleTime=600);
	...
	unsigned long long InsertID() throw(CException);
